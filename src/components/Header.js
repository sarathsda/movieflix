...
const Header = () => {
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row justify-between mx-2 max-w-5xl sm:mx-auto items-center py-6">
        ...
        <div className="flex flex-col sm:flex-row items-center space-y-2 sm:space-y-0 sm:space-x-5">
          ...
          <select
            value={sortingOption}
            onChange={handleSortChange}
            className="border rounded-md p-2 mt-2 sm:mt-0 sm:ml-2"
          >
            <option value="popularity">Popularity</option>
            <option value="release_date">Release Date</option>
          </select>
